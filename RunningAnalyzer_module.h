#ifndef RunningAnalyzer_Module
#define RunningAnalyzer_Module 1
...
namespace kaon_reconstruction{
  class RunningAnalyzer : public art::EDAnalyzer {
  public:
    
    explicit RunningAnalyzer(fhicl::ParameterSet const& pset);
    virtual ~RunningAnalyzer();
...
private:
  ...
  std::string fTrackRecoAlgModuleLabel;
  std::string fPidModuleLabel; //uB: fPIDLabel
  std::string fCaloModuleLabel; //uB: fCalorimetryModuleLabel
  std::string fPidRecoAlgModuleLabel; //uB: fPIDLabel
  std::string fCaloRecoAlgModuleLabel; //uB: fCalorimetryModuleLabel
  ...
  std::string fHitTrackRecoAlgAssns;
